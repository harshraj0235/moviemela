...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'Learn more about Movie Review by Moneycal and our mission.',
};

export default function About() {
  return (
    <main className="container" style={{ maxWidth: '800px', margin: '4rem auto' }}>
      <h1 style={{ fontSize: '3rem', marginBottom: '2rem' }}>About Movie Review by Moneycal</h1>
      <div className="review-content">
        <p>
          Welcome to <strong>Movie Review by Moneycal</strong>, your ultimate destination for honest, in-depth, and passionate movie reviews. 
        ...
        <p>
          Movie Review by Moneycal is proudly a subsidiary of <strong>moneycal.in</strong>, extending our commitment to quality content and user trust.
        </p>
      </div>
    </main>
  );
