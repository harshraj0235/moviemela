      ...
      <div className="review-content">
        ...
        <div style={{ marginTop: '3rem', padding: '2rem', border: '1px solid var(--glass-border)', borderRadius: '12px', background: 'var(--glass-bg)' }}>
          ...
          <form style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginTop: '1rem' }}>
            ...
            <button type="button" style={{ padding: '1rem', background: 'var(--primary-color)', color: '#000', fontWeight: 'bold', border: 'none', borderRadius: '6px', cursor: 'pointer' }}>Submit</button>
          </form>
        </div>
      </div>
    </main>
